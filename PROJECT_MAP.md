...
│   ├── layout.tsx                   (root layout, bọc <ChromeToanSite/> quanh Header+ThanhDieuHuong, script chống FOUC, metadata.title "Truyện chữ dịch")
...
│   │       ├── KhungDocChuong.tsx   (client - khung đọc, chặn copy nội dung, icon nhà + Aa + Danh sách chương fixed trên cùng, quản lý state cài đặt đọc)
...
├── components/
│   ├── ChromeToanSite.tsx           (client component - ẩn Header/ThanhDieuHuong theo route, dùng usePathname; ẩn ở trang đọc chương)
